...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/StatusBarManagerService;Lcom/android/server/LightsService;)V
    ...
    iput-boolean v15, v0, Lcom/android/server/NotificationManagerService;->mQuietHoursEnabled:Z
    ...
    iput-boolean v15, v0, Lcom/android/server/NotificationManagerService;->mQuietHoursMute:Z
    ...
    iput-boolean v15, v0, Lcom/android/server/NotificationManagerService;->mQuietHoursDim:Z
    ...
    iput-object v15, v0, Lcom/android/server/NotificationManagerService;->mCustomLedColors:Ljava/util/HashMap;
    ...
    invoke-virtual {v8, v15}, Landroid/content/IntentFilter;->addDataScheme(Ljava/lang/String;)V
    ...
    invoke-virtual {v15, v0, v8}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
    ...
    invoke-direct {v9, v0, v15}, Lcom/android/server/NotificationManagerService$QuietHoursSettingsObserver;-><init>(Lcom/android/server/NotificationManagerService;Landroid/os/Handler;)V
...
.method static synthetic access$2400(Lcom/android/server/NotificationManagerService;)Ljava/util/HashMap;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/NotificationManagerService;
...
.method static synthetic access$2500(Lcom/android/server/NotificationManagerService;Ljava/lang/String;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/NotificationManagerService;
...
.method static synthetic access$4402(Lcom/android/server/NotificationManagerService;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/server/NotificationManagerService;
    .param p1, "x1"    # Z
...
.method private inQuietHours()Z
    ...
    invoke-static {v0, v1}, Lcom/android/internal/util/aokp/QuietHoursHelper;->inQuietHours(Landroid/content/Context;Ljava/lang/String;)Z
...
.method private updateLightsLocked()V
    ...
    const-string v10, "led_screen_on"

    invoke-static {v8, v10, v4}, Landroid/provider/Settings$AOKP;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    iget-boolean v8, p0, Lcom/android/server/NotificationManagerService;->mQuietHoursDim:Z
    ...
    invoke-direct {p0, v8}, Lcom/android/server/NotificationManagerService;->getLedColor(Lcom/android/server/NotificationManagerService$NotificationRecord;)Ljava/lang/String;

    move-result-object v7

    .line 2309
    .local v7, "stringColor":Ljava/lang/String;
    if-eqz v7, :cond_8
    ...
    invoke-virtual {v8, v0, v9, v3, v2}, Lcom/android/server/LightsService$Light;->setFlashing(IIII)V
